...
import 'package:attend2/final/Cforgottenpasword.dart';
import 'package:attend2/final/clientRegistrationf.dart';
...
class _StudentLoginPageState extends State<StudentLoginPage>
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => const ClientRegistrationF(),
                      ),
                    );
                    print('Register');
                  },
  ...
  void loginclient(BuildContext context) async {
    ...
    try {
      var response = await Api.loginclient(pdata);
      ...
      if (msg == 'logged in') {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                HomeStudentPage(ids: id), // Pass 'id' as 'ids'
          ),
        );
      } else {
